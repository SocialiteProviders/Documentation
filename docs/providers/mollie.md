...
* The listener that you add for this provider is `'SocialiteProviders\\Mollie\\MollieExtendSocialite@handle',`.
...
* [Laravel docs about events](https://laravel.com/docs/5.7/events)
...
* [Laravel docs on configuration](https://laravel.com/docs/5.7/configuration)
...
return Socialite::with('Mollie')->stateless(false)->redirect();

// to use stateless
return Socialite::with('Mollie')->stateless()->redirect();
```
...
return Socialite::with('Mollie')->setConfig($config)->redirect();
```
