...
* The listener that you add for this provider is `'SocialiteProviders\\Snapchat\\SnapchatExtendSocialite@handle',`.
...
```php
// to use stateless
return Socialite::with('snapchat')->stateless()->redirect();
```
...
* [Snapchat Snap Kit Docs](https://docs.snapchat.com/docs)
